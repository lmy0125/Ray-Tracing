...
struct Material {
  glm::vec3 ambient = glm::vec4(0.5f, 0.0f, 0.0f);
  glm::vec3 diffuse = glm::vec4(1.0f, 1.0f, 1.0f);
  glm::vec3 specular = glm::vec4(0.0f, 0.0f, 0.0f);
  glm::vec3 emision = glm::vec4(0.0f, 0.0f, 0.0f);
